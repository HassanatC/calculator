...
/* class Calculator {
    ...
    constructor(previousOpText, currentOpText) {
        ...
        // as soon as calculator is called, use clear function to clear the screen in put with ''.
        this.clear()
    }
    ...
    appendNumber(number) {
        ...
        if(number === '.' && this.currentOperand.includes('.')) return //this prevents multiple periods from being added.
